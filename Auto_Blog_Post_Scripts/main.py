...
#main summary = define folder paths, combine files to create blog and call push to git


#1 - Define your repo path

#git repo folder - the folder that holds the changes and commits
#PATH_TO_BLOG_REPO = example Path('C/path/to/.git')
...
#3 - Get Blog image from openai_utils using title and unique image name provided here
